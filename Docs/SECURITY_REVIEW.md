...
**结论**：代码层基础良好。**2026-06-06 复核：H1/H2 两个高危项已整改关闭**（服务器已设强随机 JWT 密钥；compose 已收口 DB/Redis/MinIO 端口且 Redis 加密码）；M1/M3/M4/L1 已随 d2c5374 代码加固生效。剩余：防火墙关闭历史放行的 5432/6379/9000、上线前限定 WEB_ORIGIN。
